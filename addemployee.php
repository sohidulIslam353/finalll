            ...
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                                <span class="input-group-addon">
                                                            <i class="ti-facebook text-success"></i>
                                                        </span>
                                        <input type="text" class="form-control " id="facebook" name="facebook" placeholder="Enter your facebook name" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <h5 class="heading">Account Login</h5>
                           ...
                           <h5 class="heading">Transection Information</h5>
                            <div class="form-group row">
                                <label for="con_password3" class="col-form-label col-sm-3">
                                  Account Holder
                                </label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="accountholder" name="accountholder" placeholder="Enter your accountholder" required="">
                                    </div>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="accountnumber" name="accountnumber" placeholder="Enter your accountnumber" required="">
                                    </div>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="bankname" name="bankname" placeholder="Enter your bankname" required="">
                                    </div>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="pannumber" name="pannumber" placeholder="Enter your pannumber " required="">
                                    </div>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="ifsc" name="ifsc" placeholder="Enter your IFSC number" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
