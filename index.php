...
$count=count($_POST);
    ...
    {       
       ...
       $password =MD5( $_POST['password']);
        $query = "SELECT * FROM administrator WHERE email = '$email' and password = '$password' and active ='2'";
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6">
            ...
            if (isset($result)) {
                echo  "<div class='alert alert-danger text-center'> User Doesn't Exist </div>";
             } 
                ?>
